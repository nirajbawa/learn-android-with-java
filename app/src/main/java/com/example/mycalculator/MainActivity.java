...
public class MainActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button b1, b2, b3, b4, nextPage, tostsPage, linearLayoutPage, relativeLayoutPage, constraintLayout, frameLayout, absoluteLayout, tableLayout, toolbar, intentBtn, csfBtn, alertDialog, listViewDemo, CustomListViewDemo, GridViewDemo, basicView, DateAndTime, recycleViewBtn, horizontalRecycleViewBtn, GridRcBtn, StaggeredRcBtn, framgentsEx, tabLayout, sharedPreferences, bottomNavigationActivity, contentProvideDemo, onlineImage;
        ...
        onlineImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, OnlineImageActiivtyDemo.class);
